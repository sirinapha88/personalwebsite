...
app.controller("ProjectCtrl", function($scope, $location){
	$scope.projects = [{
		...
		desc:"Booking web site for pet hotels. It allows a user to search, compare prices, and book reservations for pet hotels.",
	...
	{
		projectName:"Food Memory Game, Nov '15",
		desc:"A memory game where the player matches a country flag with the traditional food of that country.",
